...
Use the [contact form](support.html). It is the only supported channel: it collects what
...
- **Bugs in the theme.** Anything that does not work as described in the theme guide: broken layouts,
  broken links, features that do not behave as documented.
- **Setup questions.** How to configure a setting, where a block lives, why something is not showing.
- **Compatibility with Shopify.** If a Shopify change breaks the theme, fixing it is on us.

Critical bugs — anything that stops shoppers from buying — are treated as a priority and fixed as
soon as we can reproduce them.

## What we do not support

- **Custom development.** Changes to the theme's code for your store, new features on request, design
...
This policy covers the THCabina theme as distributed through the Shopify Theme Store. Shopify
